<template>
  <v-row class="app-invoice-preview">
        ...
        <v-card-text class="py-9 px-8">
          <div class="invoice-total d-flex justify-space-between flex-column flex-sm-row">
            <div class="mb-2 mb-sm-0">
              <p class="mb-1"><span class="font-weight-semibold">Salesperson:</span> <span>Jenny Parker</span></p>
    ...
    <v-col cols="12" md="3">
      <v-card>
        <v-card-text>
          <v-btn color="primary" class="mb-3" block @click="isInvoiceSendSidebarActive = true">
            <v-icon class="me-2" left>
              {{ icons.mdiSendOutline }}
            </v-icon>
            <span>Send Invoice</span>
          </v-btn>
          <v-btn class="mb-3" color="secondary" block outlined> Download </v-btn>
          <v-btn class="mb-3" color="secondary" block outlined @click="printInvoice"> Print </v-btn>
          <v-btn
            class="mb-3"
            color="secondary"
            block
