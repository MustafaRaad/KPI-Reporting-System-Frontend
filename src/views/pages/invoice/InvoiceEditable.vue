<template>
  <v-card v-if="data.invoiceData" class="app-invoice-editable">
    <!-- Header -->
        ...
        <div :class="$vuetify.rtl ? 'text-left' : 'text-right'">
          ...
          <div class="mb-4 d-flex align-center">
            ...
            >
              ...
              <v-date-picker v-model="data.invoiceData.issuedDate" @input="isIssueDateMenuOpen = false"></v-date-picker>
            </v-menu>
          </div>
          <div class="mb-2 d-flex align-center justify-end">
            ...
            >
              ...
              <v-date-picker v-model="data.invoiceData.dueDate" @input="isDueDateMenuOpen = false"></v-date-picker>
            </v-menu>
          </div>
        </div>
      </div>
    ...
    <v-card-text class="py-9 px-8">
      <div class="d-flex justify-space-between flex-wrap flex-column flex-sm-row">
        <div class="mb-6 mb-sm-0">
          ...
          <p v-if="data.invoiceData.client.address" class="mb-1">
        ...
        <div>
          <p class="font-weight-semibold payment-details-header">Bill To:</p>
          <table>
            <tr>
      ...
      >
        ...
        <v-card outlined class="d-flex">
            ...
            <v-row>
              ...
              <v-col cols="12" md="2" sm="4">
                <v-text-field
                  ...
                  @input="
                    val => {
                      purchasedProduct.cost = Math.abs(val)
                    }
                  "
                ></v-text-field>
              </v-col>
              <v-col cols="12" md="2" sm="4">
                <v-text-field
                  ...
                  @input="
                    val => {
                      purchasedProduct.hours = Math.abs(val)
                    }
                  "
                ></v-text-field>
              </v-col>
          ...
          <div class="d-flex flex-column item-actions rounded-0 pa-1">
            <v-btn icon small @click="data.purchasedProducts.splice(purchasedProductIndex, 1)">
              <v-icon size="20">
                {{ icons.mdiClose }}
              </v-icon>
            </v-btn>
