    ...
    <v-col cols="12" md="3">
      <v-card class="mb-6">
        <v-card-text>
          ...
          <v-btn class="mb-3" color="secondary" block outlined> Save </v-btn>
      ...
      <div class="d-flex align-center justify-space-between mb-3">
        ...
        <v-switch hide-details="auto" class="mt-0" :input-value="true"></v-switch>
      </div>

      <div class="d-flex align-center justify-space-between mb-3">
        <span>Client Notes</span>
        <v-switch hide-details="auto" :input-value="false" class="mt-0"></v-switch>
      </div>
      <div class="d-flex align-center justify-space-between">
        <span>Payment Stub</span>
        <v-switch class="mt-0" hide-details="auto" :input-value="false"></v-switch>
      </div>
    </v-col>
